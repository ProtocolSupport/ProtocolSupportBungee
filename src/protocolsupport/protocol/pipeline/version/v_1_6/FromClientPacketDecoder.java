...
import protocolsupport.protocol.packet.middleimpl.readable.play.v_6.VehicleControlPacket;
...
public class FromClientPacketDecoder extends LegacyAbstractFromClientPacketDecoder {

	{
		...
		registry.register(Protocol.GAME, LegacyPacketId.Serverbound.PLAY_VEHICLE_CONTROL, VehicleControlPacket.class);
