package protocolsupport.protocol.transformer.v_1_5.handlers;
...
public class ServerConnectHandler extends PacketHandler {
	...
	public void connected(ChannelWrapper channel) throws Exception {
		...
		HandshakePacket copiedHandshake = new HandshakePacket(this.user.getPendingConnection().getLoginRequest().getData(), originalHandshake.getHost(), originalHandshake.getPort());
