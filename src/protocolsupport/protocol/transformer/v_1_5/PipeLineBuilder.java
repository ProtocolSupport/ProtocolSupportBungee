...
public class PipeLineBuilder implements IPipeLineBuilder {
	...
	public void buildPipeLine(Channel channel, ProtocolVersion version) {
		...
		pipeline.replace(PipelineUtils.PACKET_DECODER, PipelineUtils.PACKET_DECODER, new PacketDecoder(Protocol.HANDSHAKE, true, ProtocolVersion.MINECRAFT_1_8.getId()));
