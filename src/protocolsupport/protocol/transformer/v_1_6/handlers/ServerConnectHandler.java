...
public class ServerConnectHandler extends PacketHandler {
	...
	public void connected(ChannelWrapper channel) throws Exception {
		...
		HandshakePacket copiedHandshake = new HandshakePacket(ProtocolSupportAPI.getProtocolVersion(this.user.getAddress()), this.user.getPendingConnection().getLoginRequest().getData(), originalHandshake.getHost(), originalHandshake.getPort());
