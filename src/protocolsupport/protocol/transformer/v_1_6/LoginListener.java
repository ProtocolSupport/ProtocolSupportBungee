...
import protocolsupport.protocol.transformer.v_1_6.handlers.EntityRewriteUpstreamBridge;
import protocolsupport.protocol.transformer.v_1_6.handlers.ServerConnectHandler;
...
public class LoginListener implements Listener {
	...
	public void onLogin(LoginEvent event) {
		ProtocolVersion version = ProtocolSupportAPI.getProtocolVersion(event.getConnection().getAddress());
		if (version != ProtocolVersion.MINECRAFT_1_6_2 && version != ProtocolVersion.MINECRAFT_1_6_4) {
			return;
		}
		try {
