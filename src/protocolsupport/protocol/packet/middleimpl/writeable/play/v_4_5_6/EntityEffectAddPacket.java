...
public class EntityEffectAddPacket extends LegacySingleWriteablePacket<EntityEffect> {
	...
	protected void write(ByteBuf data, EntityEffect packet) {
		...
		data.writeByte(packet.getAmplifier());
		data.writeShort(packet.getDuration());
	}
